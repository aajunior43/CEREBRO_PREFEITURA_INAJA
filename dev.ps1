...
$host.UI.RawUI.WindowTitle = "CREDORES_FIXOS_MENSAIR - Servidor Flask"
...
try {
    ...
    if (-not (Test-Path $lnkPath)) {
        try {
            ...
            $lnk.Description      = 'CREDORES - Servidor Flask'
    ...
    # ---- Resumo ----
    Show-Summary -LocalIPs $localIPs

    # ---- Aguardar (ate Ctrl+C) ----
    Write-Info "Servidor ativo. Pressione Ctrl+C para encerrar."
    while ($true) {

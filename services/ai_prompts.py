...
PROMPT_TEMPLATES = {
    ...
    "classificador_despesa": PromptTemplate(
        system_template=(
            ...
            "\n--- DESPESAS DE CUSTEIO (Grupo 3) ---\n"
            "PESSOAL E ENCARGOS (3.1.90.11 — Custeio, Elemento 11): "
            "vencimentos, salários, proventos, aposentadorias, pensões, adicionais (insalubridade, periculosidade, noturno), "
            "gratificações, indenizações (transporte, alimentação, pré-escolar), férias, 13º salário, "
            "licença-prêmio, abono pecuniário. APENAS para servidores públicos efetivos e comissionados.\n"
            "OBRIGAÇÕES PATRONAIS (3.1.90.13 — Custeio, Elemento 13): "
            "INSS patronal, FGTS, PIS/PASEP sobre folha, contribuições previdenciárias do empregador, "
            "indenizações por rescisão contratual do servidor. APENAS encargos sobre pessoal.\n"
            "DIÁRIAS (3.3.90.14 — Custeio, Elemento 14): "
            "diárias para servidores em viagem oficial (hospedagem, alimentação, deslocamento), "
            "meia-diária (viagem sem pernoite), diárias no exterior. APENAS para pessoa física (servidor).\n"
            "PASSAGENS (3.3.90.33 — Custeio, Elemento 33): "
            "passagens aéreas, rodoviárias, ferroviárias, marítimas para servidores em viagem oficial, "
            "passagens para deslocamento municipal/interestadual. APENAS transporte de pessoas (servidor).\n"
            "SERVIÇOS DE TRANSPORTE (3.3.90.35 — Custeio, Elemento 35): "
            "transporte de cargas, mudança, frete de materiais, transporte de valores, "
            "locação de veículos com motorista, transporte escolar terceirizado, ambulância terceirizada.\n"
            ...
            "(manutenção corrente, sem aumento de vida útil), material educacional, material de comunicação.\n"
            ...
            "hospedagem e alimentação de servidor em viagem oficial, pagamento a autônomos sem vínculo.\n"
            ...
            "treinamento e capacitação de servidores, cursos, workshops, congressos.\n"
            "LOCAÇÃO DE IMÓVEIS (3.3.90.04 — Custeio, Elemento 04): "
            "aluguel de prédios, salas comerciais, galpões, terrenos, imóveis residenciais para programas sociais.\n"
            "OUTROS BENEFÍCIOS ASSISTENCIAIS (3.3.90.08 — Custeio, Elemento 08): "
            "auxílio-creche, auxílio-alimentação, auxílio-transporte (não indenizatório), "
            "benefícios assistenciais a servidores (LOAS, BPC), vale-refeição.\n"
            "PREMIAÇÕES CULTURAIS, ESPORTIVAS (3.3.90.31 — Custeio, Elemento 31): "
            "prêmios em dinheiro, medalhas, troféus, bolsas de estudo, incentivos culturais e esportivos.\n"
            "MATERIAL PARA DISTRIBUIÇÃO GRATUITA (3.3.90.32 — Custeio, Elemento 32): "
            "livros didáticos, medicamentos para distribuição gratuita, merenda escolar, "
            "materiais entregues à população (kits higiene, cestas básicas).\n"
            "OBRIGAÇÕES TRIBUTÁRIAS (3.3.90.47 — Custeio, Elemento 47): "
            "IPTU, IPVA, taxas de incêndio, tarifas de água/esgoto (quando município é contribuinte), "
            "contribuições de iluminação pública, taxas de licenciamento.\n"
            "AUXÍLIO FINANCEIRO A ENTIDADES PRIVADAS (3.3.90.48 — Custeio, Elemento 48): "
            "subvenções sociais a ONGs, associações comunitárias, entidades assistenciais, "
            "transferências a instituições sem fins lucrativos.\n"
            "OUTROS ENCARGOS (3.3.90.92 — Custeio, Elemento 92): "
            "despesas de exercícios anteriores (não pagas no ano devido), "
            "dívidas reconhecidas, precatórios (exceto alimentares), sentenças judiciais.\n"
            "INDENIZAÇÕES (3.3.90.93 — Custeio, Elemento 93): "
            "indenizações trabalhistas, perdas e danos, devoluções de valores pagos indevidamente.\n"
            "\n--- DESPESAS DE INVESTIMENTO (Grupo 4) ---\n"
            ...
            "construção de pontes, viadutos, passarelas, ginásios esportivos, escolas, postos de saúde.\n"
            ...
            "computadores, notebooks, tablets, impressoras, monitores, servidores, "
            ...
            "ferramentas de longa duração (vida útil > 1 ano), "
            "aparelhos e utensílios (domésticos, cozinha industrial).\n"
            "AQUISIÇÃO DE IMÓVEIS (4.5.90.61 — Investimento, Elemento 61): "
            "compra de terrenos, prédios, casas, apartamentos, galpões para uso público.\n"
            "CONCESSÃO DE EMPRÉSTIMOS (4.5.90.71 — Investimento, Elemento 71): "
            "empréstimos a servidores, consignados, adiantamentos.\n"
            "EQUIPAMENTOS PARA EMPRESAS PÚBLICAS (4.4.90.34 — Investimento, Elemento 34): "
            "aquisição de bens para empresas estatais municipais.\n"
            "\n--- INVERSÕES FINANCEIRAS (Grupo 5) ---\n"
            "AQUISIÇÃO DE TÍTULOS (5.5.90.63 — Inversão, Elemento 63): "
            "aquisição de títulos públicos, ações de empresas, cotas de fundos.\n"
            "CONCESSÃO DE SUBVENÇÕES (5.5.90.64 — Inversão, Elemento 64): "
            "subvenções econômicas a empresas privadas.\n"
            "\n=== EXEMPLOS HISTÓRICOS PERFEITOS (FEW-SHOT LEARNING) ===\n"
            "Siga rigorosamente estes 10 exemplos práticos do dia a dia municipal:\n"
            "1. 'Óleo Diesel S10' -> Elemento 30 (3.3.90.30 - Material de Consumo). Justificativa: Combustível é consumido no uso imediato.\n"
            "2. 'Aquisição de Ambulância' -> Elemento 52 (4.4.90.52 - Equipamentos e Material Permanente). Justificativa: Veículo com vida útil estrutural longa.\n"
            "3. 'Assinatura Sistema Betha / Software' -> Elemento 39 (3.3.90.39 - Serviços PF). Justificativa: Locação e serviços de TI são prestados por PJ.\n"
            "4. 'Pagamento de Diárias para Motorista' -> Elemento 36 (3.3.90.36 - Serviços PF). Justificativa: Indenização para viagens de pessoa física da equipe.\n"
            "5. 'Cartucho de Tinta e Toner' -> Elemento 30 (3.3.90.30 - Material de Consumo). Justificativa: Insumo de uso imediato de expediente.\n"
            "6. 'Reforma e Pavimentação Asfáltica da Rua X' -> Elemento 51 (4.4.90.51 - Obras e Instalações). Justificativa: Construção/manutenção de infraestrutura de longa duração.\n"
            "7. 'Locação de Máquinas Retroescavadeiras' -> Elemento 39 (3.3.90.39 - Serviços PJ). Justificativa: Locação não é investimento, é prestação de serviço jurídico contínuo.\n"
            "8. 'Atestado Digital A1 / Certificado Digital' -> Elemento 39 (3.3.90.39 - Serviços PJ). Justificativa: Precedentes do TCE determinam certificado como serviço de terceiros.\n"
            "9. 'Compra de Cadernos e Lápis (Merenda/Educação)' -> Elemento 30 (3.3.90.30 - Material de Consumo). Justificativa: Uso e desgaste escolar rápido e direto.\n"
            "10. 'Aquisição de Armários de Aço' -> Elemento 52 (4.4.90.52 - Equipamentos e Material Permanente). Justificativa: Mobiliário corporativo entra no inventário e depreciação.\n"
            "\n=== FORMATO DE RESPOSTA ===\n"

...
PROMPT_TEMPLATES = {
    ...
    "classificador_despesa": PromptTemplate(
        system_template=(
            ...
            "(b) Serviços: PF sem vínculo = elemento 36. PJ ou empresa = elemento 39. "
            "Certificados digitais (A1, A3, e-CPF, e-CNPJ), licenças de software, assinaturas de sistemas, "
            "contabilidade, consultoria, manutenção, limpeza, segurança = SEMPRE 3.3.90.39 (Serviços de Terceiros, PJ). "

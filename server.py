...
# ── Logging ──────────────────────────────────────────────
    ...
    def init_db():
        ...
        for sql in [
            ...
            "CREATE TABLE IF NOT EXISTS fornecimento_templates (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT NOT NULL UNIQUE, dados TEXT NOT NULL DEFAULT '{}', criado_em TEXT DEFAULT (datetime('now','localtime')), atualizado_em TEXT DEFAULT (datetime('now','localtime')))",
